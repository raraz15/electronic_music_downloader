...
def make_beatport_query(track_title):
    ...
    try:
        ...
        query_str=re.sub(r"'","%27",track_title)
        ...
        track_url_ext=t.find("div",{"class": "buk-track-meta-parent"}).find("a")["href"]
        return HOME_PAGE+"/"+track_url_ext
    except:
